...
from regression.entities.preparation import Preparation, NumericalFeature, CategoricalFeature
...
class XGBoost:
    ...
    def analyze(self, train_file):
        ...
        target_feature_name = types.keys()[columns_number - 1]
